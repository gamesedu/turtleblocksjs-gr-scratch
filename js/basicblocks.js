...
function initBasicProtoBlocks(palettes, blocks) {
    ...
    headingBlock.staticLabels.push(_('πορεία'));
    ...
    clearBlock.staticLabels.push(_('Καθάρισε'));
    ...
    arcBlock.staticLabels.push(_('τόξο'), _('Γωνία'), _('ακτίνα'));
    ...
    setheadingBlock.staticLabels.push(_('Όρισε Γωνία Πορείας'));
    ...
    setxyBlock.staticLabels.push(_('Όρισε xy'), _('x'), _('y'));
    ...
    rightBlock.staticLabels.push(_('Δεξιά'));
    ...
    leftBlock.staticLabels.push(_('Αριστερά'));
    ...
    backBlock.staticLabels.push(_('Πίσω'));
    ...
    forwardBlock.staticLabels.push(_('Μπροστά'));
    ...
    fillscreenBlock.staticLabels.push(_('φόντο'));
    ...
    colorBlock.staticLabels.push(_('χρώμα'));
    ...
    shadeBlock.staticLabels.push(_('σκιά'));
    ...
    chromaBlock.staticLabels.push(_('γκρί'));
    ...
    pensizeBlock.staticLabels.push(_('Μέγεθος Στυλό'));
    ...
    setfontBlock.staticLabels.push(_('Όρισε font'));
    ...
    penupBlock.staticLabels.push(_('Στυλό Άνω'));
    ...
    pendownBlock.staticLabels.push(_('Στυλό Κάτω'));
    ...
    setpensizeBlock.staticLabels.push(_('μέγεθος στιλό'));
    ...
    settranslucencyBlock.staticLabels.push(_('όρισε translucency'));
    ...
    sethueBlock.staticLabels.push(_('όρισε hue'));
    ...
    setshadeBlock.staticLabels.push(_('όρισε shade'));
    ...
    setchromaBlock.staticLabels.push(_('όρισε grey'));
    ...
    setcolorBlock.staticLabels.push(_('όρισε χρώμα'));
    ...
    andBlock.staticLabels.push(_('ΚΑΙ'));
    ...
    orBlock.staticLabels.push(_('Ή (or)'));
    ...
    notBlock.staticLabels.push(_('ΟΧΙ (not)'));
    ...
    modBlock.staticLabels.push(_('υπόλοιπο'));
    ...
    sqrtBlock.staticLabels.push(_('Τετραγ. Ρίζα (sqrt)'));
    ...
    randomBlock.staticLabels.push(_('Τυχαίο'), _('min'), _('max'));
    ...
    incrementOneBlock.staticLabels.push(_('Αύξησε κατα 1 (add 1 to)'));
    ...
    boxBlock.staticLabels.push(_('πλαίσιο'));
    ...
    storeinBlock.staticLabels.push(_('αποθήκευση στο'), _('όνομα'), _('τιμή'));
    ...
    namedBoxBlock.staticLabels.push(_('πλαίσιο'));
    ...
    startBlock.staticLabels.push(_('Αρχή'));
	...
	untilBlock.staticLabels.push(_('Μέχρι / until'), _('κάνε / do'));
	...
	whileBlock.staticLabels.push(_('ΕΝΩ / while'), _('κάνε/do'));
	...
	ifthenelseBlock.staticLabels.push(_('Εάν'), _('τότε'), _('αλλιώς'));
	...
	ifBlock.staticLabels.push(_('Εάν'), _('τότε'));
	...
	foreverBlock.staticLabels.push(_('για πάντα'));
	...
	repeatBlock.staticLabels.push(_('επανέλαβε'));
    ...
    */
	...
	startTurtleBlock.staticLabels.push(_('Ξεκίνα χελώνα'));
	...
	stopTurtleBlock.staticLabels.push(_('Σταμάτα Χελώνα'));
